...
local targets = [
      ...
      { "os": "linux", "name": "fc37", "isas": [ "amd64", "arm64" ], "events": ["push", "tag" ] },
      { "os": "linux", "name": "fc36", "isas": [ "amd64", "arm64", "armv7" ], "events": ["push", "tag" ] },
      { "os": "linux", "name": "fc35", "isas": [ "amd64", "arm64", "armv7" ], "events": ["push", "tag" ] },
