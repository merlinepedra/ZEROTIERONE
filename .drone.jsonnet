...
local targets = [
      ...
      { "os": "linux", "name": "fc34","isas": [ "amd64" ], "events": ["push", "tag" ] },
      { "os": "linux", "name": "amzn2", "isas": [ "amd64" ], "events": ["push", "tag" ] },
      { "os": "linux", "name": "jammy", "isas": [ "amd64"], "events": ["push", "tag" ] },
      ...
      { "os": "linux", "name": "bookworm", "isas": [ "amd64" ], "events": ["push", "tag" ] },
      ...
      // { "os": "linux", "name": "fc34","isas": [ "amd64", "arm64", "armv7" ], "events": ["push", "tag" ] },
