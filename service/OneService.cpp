...
public:
		...
		,_ssoRedirectURL()
	{
		...
		fprintf(stdout, "_incomingPacketConcurrency=%d\n", _incomingPacketConcurrency);
	...
	{
#ifdef ZT_MULTITHREADED_IO
		// Shut down concurrent packet queues
...
#ifdef ZT_MULTITHREADED_IO
		// Delete any packets waiting for ingestion
